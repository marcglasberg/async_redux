...
- [2. Why use this Redux version over others?](#2-why-use-this-redux-version-over-others)
- [3. Store and State](#3-store-and-state)
- [4. Actions](#4-actions)
    - [4.1. Sync Reducer](#41-sync-reducer)
    - [4.2. Async Reducer](#42-async-reducer)
        - [4.2.1. One important rule](#421-one-important-rule)
    - [4.3. Changing state is optional](#43-changing-state-is-optional)
    - [4.4. Before and After the Reducer](#44-before-and-after-the-reducer)
        - [4.4.1. What's the order of execution of sync and async reducers?](#441-whats-the-order-of-execution-of-sync-and-async-reducers)
- [5. Connector](#5-connector)
    - [5.1. How to provide the ViewModel to the StoreConnector](#51-how-to-provide-the-viewmodel-to-the-storeconnector)
- [6. Alternatives to the Connector](#6-alternatives-to-the-connector)
    - [6.1. Provider](#61-provider)
- [7. Processing errors thrown by Actions](#7-processing-errors-thrown-by-actions)
    - [7.1. Giving better error messages](#71-giving-better-error-messages)
    - [7.2. User exceptions](#72-user-exceptions)
    - [7.3. Converting third-party errors into UserExceptions](#73-converting-third-party-errors-into-userexceptions)
    - [7.4. UserExceptionAction](#74-userexceptionaction)
- [8. Testing](#8-testing)
    - [8.1. Testing UserExceptions](#81-testing-userexceptions)
    - [8.2. Test files](#82-test-files)
- [9. Route Navigation](#9-route-navigation)
- [10. Events](#10-events)
    - [10.1. Can I put mutable events into the store state?](#101-can-i-put-mutable-events-into-the-store-state)
    - [10.2. When should I use events?](#102-when-should-i-use-events)
    - [10.3. Advanced event features](#103-advanced-event-features)
- [11. Waiting until an Action is finished](#11-waiting-until-an-action-is-finished)
- [12. State Declaration](#12-state-declaration)
    - [12.1. Selectors](#121-selectors)
- [13. Action Subclassing](#13-action-subclassing)
    - [13.1. Abstract Before and After](#131-abstract-before-and-after)
- [14. IDE Navigation](#14-ide-navigation)
- [15. Persistence](#15-persistence)
    - [15.1. Saving and Loading](#151-saving-and-loading)
- [16. Logging](#16-logging)
- [17. Observing rebuilds](#17-observing-rebuilds)
- [18. How to interact with the database](#18-how-to-interact-with-the-database)
- [19. How to deal with Streams](#19-how-to-deal-with-streams)
    - [19.1. So, how do you use streams?](#191-so-how-do-you-use-streams)
    - [19.2. Where the stream subscriptions themselves are stored](#192-where-the-stream-subscriptions-themselves-are-stored)
    - [19.3. How do streams pass their information to the store and ultimately to the widgets?](#193-how-do-streams-pass-their-information-to-the-store-and-ultimately-to-the-widgets)
    - [19.4. To sum up:](#194-to-sum-up)
- [20. Recommended Directory Structure](#20-recommended-directory-structure)
- [21. Where to put your business logic](#21-where-to-put-your-business-logic)
- [22. Architectural discussion](#22-architectural-discussion)
    - [22.1. Is AsyncRedux really Redux?](#221-is-asyncredux-really-redux)
    - [22.2. Besides the reduction of boilerplate, what are the main advantages of the AsyncRedux architecture?](#222-besides-the-reduction-of-boilerplate-what-are-the-main-advantages-of-the-asyncredux-architecture)
    - [22.3. Is AsyncRedux a minimalist or lightweight Redux version?](#223-is-asyncredux-a-minimalist-or-lightweight-redux-version)
    - [22.4. Is the AsyncRedux architecture useful for small projects?](#224-is-the-asyncredux-architecture-useful-for-small-projects)
...
## 2. Why use this Redux version over others?
...
### 4.3. Changing state is optional
...
### 4.4. Before and After the Reducer 
...
#### 4.4.1. What's the order of execution of sync and async reducers?
...
### 5.1. How to provide the ViewModel to the StoreConnector
...
## 6. Alternatives to the Connector
...
## 7. Processing errors thrown by Actions
...
### 7.1. Giving better error messages 
...
### 7.3. Converting third-party errors into UserExceptions
...
### 10.1. Can I put mutable events into the store state?
...
## 11. Waiting until an Action is finished
...
### 13.1. Abstract Before and After
...
## 18. How to interact with the database
...
### 19.1. So, how do you use streams? 
...
### 19.2. Where the stream subscriptions themselves are stored 
...
### 19.3. How do streams pass their information to the store and ultimately to the widgets?
...
## 21. Where to put your business logic
...
### 22.1. Is AsyncRedux really Redux?
...
### 22.2. Besides the reduction of boilerplate, what are the main advantages of the AsyncRedux architecture?
...
### 22.3. Is AsyncRedux a minimalist or lightweight Redux version?
...
### 22.4. Is the AsyncRedux architecture useful for small projects?
